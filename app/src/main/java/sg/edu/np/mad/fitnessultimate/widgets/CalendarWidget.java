    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        if (options != null) {
            ...
            if (sizeOfWidget == 2) {
                ...
                views.setViewLayoutMargin(R.id.calendar_widget_gridView, RemoteViews.MARGIN_START, 1.5F, TypedValue.COMPLEX_UNIT_DIP);
                views.setInt(R.id.calendar_widget_gridView, "setNumColumns", 7);
            } else if (sizeOfWidget == 3) {
                numOfCols = 12;
                widthOfCell = (float) innerWidgetWidth/numOfCols;
                views.setViewLayoutMargin(R.id.calendar_widget_gridView, RemoteViews.MARGIN_START, 1.5F, TypedValue.COMPLEX_UNIT_DIP);
                views.setInt(R.id.calendar_widget_gridView, "setNumColumns", 12);
            } else if (sizeOfWidget == 4) {
                innerWidgetWidth += 1;
                numOfCols = 16;
                widthOfCell = (float) innerWidgetWidth/numOfCols;
                views.setViewLayoutMargin(R.id.calendar_widget_gridView, RemoteViews.MARGIN_START, 5.5F, TypedValue.COMPLEX_UNIT_DIP);
                views.setInt(R.id.calendar_widget_gridView, "setNumColumns", 16);
            }
        }
        ...
        intent.putExtra("key", numOfCols != 0 ? numOfCols : 7); // Ensure unique extras
        ...
        views.setOnClickPendingIntent(R.id.calendar_widget, pendingIntent);
